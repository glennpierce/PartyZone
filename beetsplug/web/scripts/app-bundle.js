        ...
        activate(params, navigationInstruction) {
            return __awaiter(this, void 0, void 0, function* () {
                if (params.album_id != undefined) {
                    this.tracks = yield this.allplay.getTracksForAlbum(+params.album_id);
                }
                else {
