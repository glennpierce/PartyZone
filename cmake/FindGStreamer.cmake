...
if(GSTREAMER_INCLUDE_DIRS AND
    ...
    (GSTREAMER_INTERFACE_LIBRARY AND GSTREAMER_APP_LIBRARY AND GSTREAMER_NET_LIBRARY) OR (GSTREAMER_VERSION_MAJOR GREATER 0) AND
...
find_library(GSTREAMER_NET_LIBRARY NAMES gstnet-${GStreamer_FIND_VERSION_MAJOR}.${GStreamer_FIND_VERSION_MINOR}
   PATHS
   ${PKG_GSTREAMER_LIBRARY_DIRS}
   )
...
if(GSTREAMER_NET_LIBRARY)
    set(GSTREAMER_LIBRARIES ${GSTREAMER_LIBRARIES} ${GSTREAMER_NET_LIBRARY})
elseif(GSTREAMER_VERSION_MAJOR GREATER 0)
   #do nothing
else(GSTREAMER_NET_LIBRARY)
   message(STATUS "GStreamer: WARNING: net library not found")
endif(GSTREAMER_NET_LIBRARY)
...
mark_as_advanced(GSTREAMER_INCLUDE_DIRS GSTREAMER_LIBRARY GSTREAMER_LIBRARIES GSTREAMER_BASE_LIBRARY GSTREAMER_INTERFACE_LIBRARY GSTREAMER_APP_LIBRARY GSTREAMER_NET_LIBRARY GSTREAMER_VERSION)
